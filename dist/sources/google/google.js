...
class Google extends source_1.OAuth2Source {
    constructor() {
        ...
        this.resources = {
            profile: new resource_1.GetResource("profile", "Google Profile", "get", "Your basic google profile", getProfile, null, google_types_1.GoogleProfile),
            drafts: new resource_1.GetResource("drafts", "Google Drafts", "get", "Your gmail drafts", getDrafts, google_types_1.GoogleDraftsInput, google_types_1.GoogleDrafts),
            parsedDrafts: new resource_1.GetResource("parsedDrafts", "Google Parsed Drafts", "get", "Your gmail parsed drafts", getParsedDrafts, google_types_1.GoogleDraftsInput, google_types_1.GoogleParsedDrafts),
            draft: new resource_1.GetResource("draft", "Google Draft", "get", "Your gmail draft", getDraft, google_types_1.GoogleDraftInput, google_types_1.GoogleDraft),
            parsedDraft: new resource_1.GetResource("parsedDraft", "Google Parsed Draft", "get", "Your gmail parsed draft", getParsedDraft, google_types_1.GoogleDraftInput, google_types_1.GoogleParsedDraft),
            labels: new resource_1.GetResource("labels", "Google Labels", "get", "Your gmail labels", getLabels, null, google_types_1.GoogleLabels),
            label: new resource_1.GetResource("label", "Google Label", "get", "Your gmail label", getLabel, google_types_1.GoogleLabelInput, google_types_1.GoogleLabel),
            messages: new resource_1.GetResource("messages", "Google Messages", "get", "Your gmail messages", getMessages, google_types_1.GoogleMessagesInput, google_types_1.GoogleMessages),
            parsedMessages: new resource_1.GetResource("parsedMessages", "Google Parsed Messages", "get", "Your gmail parsed messages", getParsedMessages, google_types_1.GoogleMessagesInput, google_types_1.GoogleParsedMessages),
            message: new resource_1.GetResource("message", "Google Message", "get", "Your gmail message", getMessage, google_types_1.GoogleMessageInput, google_types_1.GoogleMessage),
            parsedMessage: new resource_1.GetResource("parsedMessage", "Google Parsed Message", "get", "Your gmail parsed message", getParsedMessage, google_types_1.GoogleMessageInput, google_types_1.GoogleParsedMessage),
            threads: new resource_1.GetResource("threads", "Google Threads", "get", "Your gmail threads", getThreads, google_types_1.GoogleThreadsInput, google_types_1.GoogleThreads),
            parsedThreads: new resource_1.GetResource("parsedThreads", "Google Parsed Threads", "get", "Your gmail parsed threads", getParsedThreads, google_types_1.GoogleThreadsInput, google_types_1.GoogleParsedThreads),
            thread: new resource_1.GetResource("thread", "Google Thread", "get", "Your gmail thread", getThread, google_types_1.GoogleThreadInput, google_types_1.GoogleThread),
            parsedThread: new resource_1.GetResource("parsedThread", "Google Parsed Thread", "get", "Your gmail parsed thread", getParsedThread, google_types_1.GoogleThreadInput, google_types_1.GoogleParsedThread),
            calendars: new resource_1.GetResource("calendars", "Google Calendars", "get", "Your google calendars", getCalendars, google_types_1.GoogleCalendarsInput, google_types_1.GoogleCalendars),
            calendar: new resource_1.GetResource("calendar", "Google Calendar", "get", "Your google calendar", getCalendar, google_types_1.GoogleCalendarInput, google_types_1.GoogleCalendar),
            events: new resource_1.GetResource("events", "Google Events", "get", "Your google events", getEvents, google_types_1.GoogleEventsInput, google_types_1.GoogleEvents),
            event: new resource_1.GetResource("event", "Google Event", "get", "Your google event", getEvent, google_types_1.GoogleEventInput, google_types_1.GoogleEvent),
        };
        this.metadata = {
            name: this.getName(),
            friendlyName: "Google",
