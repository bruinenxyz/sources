...
export declare const NotionCommentsInput: {
    readonly type: "object";
    readonly description: "The input for a Notion comments query";
    readonly properties: {
        readonly block_id: {
            readonly type: "string";
    ...
    readonly required: readonly ["block_id"];
};
export declare const NotionComments: {
    readonly type: "object";
    readonly description: "The response for a Notion comments query";
    readonly properties: {
        readonly object: {
            readonly type: "string";
            readonly description: "The object type of the comments query response";
        };
        readonly next_cursor: {
            readonly type: "string";
            readonly description: "The next cursor of the comments query response";
        };
        readonly has_more: {
            readonly type: "boolean";
            readonly description: "Whether the comments query response has more";
        };
        readonly type: {
            readonly type: "string";
            readonly description: "The type of the comments query response";
        };
        readonly comment: {
            readonly type: "object";
            readonly description: "The comment of the comments query response";
        };
        readonly results: {
            readonly type: "array";
            readonly description: "The results of the comments query response";
            readonly items: {
                readonly type: "object";
                readonly description: "A result object of the comments query response";
                readonly properties: {
                    readonly object: {
                        readonly type: "string";
                        readonly description: "Always 'comment'";
                    };
                    readonly id: {
                        readonly type: "string";
                        readonly description: "The ID of the comment";
                    };
                    readonly parent: {
                        readonly type: "object";
                        readonly description: "The parent of the comment";
                        readonly properties: {
                            readonly type: {
                                readonly type: "string";
                                readonly description: "The type of the parent";
                    ...
                    readonly discussion_id: {
                        readonly type: "string";
                        readonly description: "The ID of the discussion";
                    };
                    readonly created_time: {
                        readonly type: "string";
                        readonly description: "The time the comment was created";
                    };
                    readonly last_edited_time: {
                        readonly type: "string";
                        readonly description: "The time the comment was last edited";
                    };
                    readonly created_by: {
                        readonly type: "object";
                        readonly description: "The user who created the comment";
                        readonly properties: {
                            readonly object: {
                                readonly type: "string";
                                readonly description: "Always 'user'";
                    ...
                    readonly rich_text: {
                        readonly type: "array";
                        readonly description: "The rich text of the comment";
                        readonly items: {
                            readonly type: "object";
                            readonly description: "A rich text object of the comment";
                            readonly properties: {
                                readonly type: {
                                    readonly type: "string";
                                    readonly description: "The type of the rich text";
                                };
                                readonly text: {
                                    readonly type: "object";
                                    readonly description: "The text of the rich text";
                                    readonly properties: {
                                        readonly content: {
                                            readonly type: "string";
                                        ...
                                        readonly link: {
                                            readonly type: "string";
                                            readonly description: "The link of the text";
                                        };
                                    };
                                };
                                readonly annotations: {
                                    readonly type: "object";
                                    readonly description: "The annotations of the rich text";
                                    readonly properties: {
                                        readonly bold: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the rich text is bold";
                                        };
                                        readonly italic: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the rich text is italic";
                                        };
                                        readonly strikethrough: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the rich text is strikethrough";
                                        };
                                        readonly underline: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the rich text is underline";
                                        };
                                        readonly code: {
                                            readonly type: "boolean";
                                            readonly description: "Whether the rich text is code";
                                        };
                                        readonly color: {
                                            readonly type: "string";
                                            readonly description: "The color of the rich text";
                                        };
                                    };
                                };
                                readonly plain_text: {
                                    readonly type: "string";
                                    readonly description: "The plain text of the rich text";
                                };
                                readonly href: {
                                    readonly type: "string";
                                    readonly description: "The href of the rich text";
                                };
                            };
                        };
                    };
...
export declare const NotionCommentOnPageBody: {
    readonly type: "object";
    readonly description: "The body for a Notion comment on page request";
    readonly properties: {
        readonly parent: {
            readonly type: "object";
            readonly description: "The parent of the comment";
        ...
        readonly rich_text: {
            ...
            readonly items: {
                readonly type: "object";
                readonly description: "A rich text object of the comment. For more information on creating a rich text object, see https://developers.notion.com/reference/rich-text";
            };
        };
    };
    readonly required: readonly ["parent", "rich_text"];
};
export declare const NotionCommentOnDiscussionBody: {
    readonly type: "object";
    readonly description: "The body for a Notion comment on discussion request";
    readonly properties: {
        readonly discussion_id: {
            readonly type: "string";
            readonly description: "The ID of the discussion";
    ...
    readonly required: readonly ["discussion_id", "rich_text"];
};
export declare const NotionComment: {
    readonly type: "object";
    readonly description: "The response for a Notion comment request";
    readonly properties: {
        readonly object: {
            readonly type: "string";
            readonly description: "Always 'comment'";
