...
export const NotionCommentsInput = {
  type: "object",
...
export const NotionCommentOnPageBody = {
  type: "object",
  ...
  properties: {
    ...
    rich_text: {
      ...
      items: {
        type: "object",
        description:
          "A rich text object of the comment. For more information on creating a rich text object, see https://developers.notion.com/reference/rich-text",
      },
    },
  },
...
export const NotionCommentOnDiscussionBody = {
  type: "object",
