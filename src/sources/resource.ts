...
export type PatchAction<Body, Params, ReturnType> = (
  authenticatedClient: any,
  body: Body,
  params: Params
) => Promise<ReturnType>;

export type DeleteAction<Params, ReturnType> = (
  authenticatedClient: any,
  params: Params
) => Promise<ReturnType>;
...
export class PatchResource<Body, Params, ReturnType> {
  public name: string;
  public friendlyName: string;
  public type: string;
  public description: string;
  public action: PatchAction<Body, Params, ReturnType>;
  public JSONBodySchema: unknown;
  public JSONInputSchema: unknown;
  public JSONOutputSchema: unknown;
  public constructor(
...
export class DeleteResource<Params, ReturnType> {
  public name: string;
  public friendlyName: string;
  public type: string;
  public description: string;
  public action: DeleteAction<Params, ReturnType>;
  public JSONInputSchema: unknown;
  public JSONOutputSchema: unknown;
  public constructor(
    name: string,
