      ...
      items: {
        ...
        properties: {
          ...
          capabilities: {
            ...
            properties: {
              ...
              canChangeSharingFoldersRequiresOrganizerPermissionRestriction: {
                type: "boolean",
                description:
                  "Whether the current user can change the sharingFoldersRestriction of this shared drive",
              },
          ...
          orgUnitId: {
            type: "string",
            description:
              "The organizational unit of this shared drive. This field is only populated when the useDomainAdminAccess parameter is set to true",
          },
        },
      },
    },
...
export const GoogleDriveFilesInput = {
  ...
  properties: {
    driveId: {
      type: "string",
      description:
        "The ID of the shared drive. If the drifeId is not provided, defaults to the user's myDrive.",
    },
    corpora: {
      type: "string",
      description:
    ...
    q: {
      type: "string",
      description:
        "A query for filtering the file results. See https://developers.google.com/drive/api/guides/search-files for supported syntax.",
    },
    spaces: {
      type: "string",
      description:
    ...
    includeLabels: {
      type: "string",
      description:
        "A comma-separated list of labels to return for each file. If specified, supported labels are 'createdTime', 'folder', 'modifiedByMeTime', 'modifiedTime', 'name', 'quotaBytesUsed', 'recency', 'sharedWithMeTime', 'starred', and 'viewedByMeTime'.",
    },
  },
} as const satisfies JSONSchema;
...
export const GoogleDriveFiles = {
  ...
  properties: {
    nextPageToken: {
      type: "string",
      description:
        "The token for the next page of files. This will be absent if the end of the files list has been reached.",
    },
    kind: {
      type: "string",
      description:
      ...
      items: {
        ...
        properties: {
          ...
          fileExtension: {
            type: "string",
            description:
              "The extension of the file. The final component of fullFileExtension. This is only available for files with binary content in Google Drive.",
          },
          copyRequiresWriterPermission: {
            type: "boolean",
            description:
              ...
              properties: {
                ...
                permissionDetails: {
                  ...
                  items: {
                    type: "object",
                    description:
                      "A set of permissions that a user with the effective role can use to access a file or folder.",
                    properties: {
                      permissionType: {
                        type: "string",
          ...
          spaces: {
            type: "array",
            description:
              "The spaces which contain the file. The currently supported values are 'drive', 'appDataFolder' and 'photos'.",
            items: {
              type: "string",
            },
          },
          ...
          capabilities: {
            ...
            properties: {
              ...
              canModifyContentRestriction: {
                type: "boolean",
                description:
                  "Whether the current user can modify the contentRestrictions on this file.",
              },
              ...
              canAcceptOwnership: {
                type: "boolean",
                description:
                  "Whether the current user can accept the ownership transfer for this file. Not populated for items in shared drives.",
              },
              canReadLabels: {
                type: "boolean",
                description:
              ...
              canModifyLabels: {
                type: "boolean",
                description:
                  "Whether the current user can modify the file's labels.",
              },
            },
          },
          ...
          contentRestrictions: {
            type: "array",
            description:
              "Content restrictions for this file. Only populated if there are content restrictions for this file.",
            items: {
              type: "object",
          ...
          linkShareMetadata: {
            ...
            properties: {
              securityUpdateEligible: {
                type: "boolean",
                description:
                  "Indicates whether the link is eligible for security update.",
              },
              securityUpdateEnabled: {
                type: "boolean",
                description:
                  "Specifies whether the link requires a password to access.",
              },
            },
          },
          labelInfo: {
